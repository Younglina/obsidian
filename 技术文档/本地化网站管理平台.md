...
一个纯前端的网站集合管理工具，支持本地数据存储、完整的CRUD操作、导入导出JSON格式数据，可打包作为 Chrome 扩展使用。

在线体验：<https://younglina.wang/tool-links/>
## 预览

![](assets/本地化网站管理平台/file-20260116145244084%201.png)
![](assets/本地化网站管理平台/file-20260116145244084.png)
![](assets/本地化网站管理平台/file-20260116145244083.png)
![](assets/本地化网站管理平台/file-20260116145244081.png)
![](assets/本地化网站管理平台/file-20260116145244079.png)
![](assets/本地化网站管理平台/file-20260116145244078.png)
## 功能特性
